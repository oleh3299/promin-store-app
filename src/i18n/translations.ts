...
export const translations: Record<Language, Translation> = {
  uk: {
    ...
    storeRequests: {
      ...
      urgentSubtitle: 'Термінова заявка технічній службі',
